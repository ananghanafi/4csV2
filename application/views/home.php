...
<html lang="en-US">
  <head>
    ...
    <title>TetraCreaSoft | Website, Mobile, Desktop App Development</title>
    <link rel="icon" href="<?php echo base_url(); ?>assets/img/logotcs.png" type="image/ico">
  ...
  <body class="size-1280">
        ...
        <div class="top-nav"> 
          ...
          <div class="logo hide-l hide-xl hide-xxl">
             <a href="<?php echo base_url(); ?>" class="logo">
              <!-- Logo White Version -->
              <img class="logo-white" src="<?php echo base_url(); ?>assets/img/logotcs.png" alt="">
              <!-- Logo Dark Version -->
              <img class="logo-dark" src="<?php echo base_url(); ?>assets/img/logotcs.png" alt="">
            </a>
          </div>                  
          <p class="nav-text"></p>
          ...
          <div class="top-nav left-menu">
             <ul class="right top-ul chevron">
                <li><a href="<?php echo base_url(); ?>index.php/Creasoft/index">Home</a></li>
    ...
    <main role="main">    
      <!-- Header -->
      <header class="section-top-padding background-image text-center" style="background-image:url(<?php echo base_url(); ?>assets/img/img-05.jpg)">
        ...
        <p class="text-white">TetraCreaSoft merupakan sebuah perusahaan yang bergerak di bidang IT. TetraCreaSoft menerima berbagai macam pembuatan aplikasi berbasis web, mobile, dan desktop untuk usaha dan bisnis anda.</p>
        <!-- Image -->
        <img class="margin-top-20 center" src="<?php echo base_url(); ?>assets/img/app.png" alt="">
          ...
          <div class="margin2x">
            <div class="s-12 m-6 l-4 margin-bottom-60">
              ...
              <div class="margin-left-60">
                <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Website</h3>
                <p>Menerima segala jenis pesanan website. Contoh produk: sistem informasi, machine learning (clustering, klasifikasi, prediksi, dll), e-commerce site, dll..</p>
            ...
            <div class="s-12 m-6 l-4 margin-bottom-60">
              ...
              <div class="margin-left-60">
                <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Desktop App</h3>
                <p>Menerima segala jenis pesanan aplikasi desktop. Contoh produk: machine learning, game, Augmented Reality, dll..</p>
                <a class="text-more-info text-primary" href="/">Read more</a>                
              </div>
            </div>
            <div class="s-12 m-6 l-4 margin-bottom-60">
              ...
              <div class="margin-left-60">
                <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Mobile App</h3>
                <p>Menerima segala jenis pesanan aplikasi mobile. Contoh produk: sistem voting, Augmented Reality, sistem informasi, game, dll</p>
                <a class="text-more-info text-primary" href="/">Read more</a>                 
              </div>
            </div>
          </div>
          ...
          <div class="margin">
            ...
            <div class="s-12 m-12 l-4">                                                                                        
              <div class="carousel-default owl-carousel carousel-hide-arrows margin-m-top-bottom-50">                                                                                              
                <div class="item">                                                                                                                                                                                                     
                  <img src="<?php echo base_url(); ?>assets/img/responsive-01.png"/>                                                                                                                                                              
                </div>              
                <div class="item">                                                                                                                                                                                                                 
                  <img src="<?php echo base_url(); ?>assets/img/responsive-02.png"/>                                                                                                                                                           
                </div>              
                <div class="item">                                                                                                                                                                                                     
                  <img src="<?php echo base_url(); ?>assets/img/responsive-03.png"/>                                                                                                                                                            
                </div>              
                <div class="item">
                  <img src="<?php echo base_url(); ?>assets/img/responsive-04.png"/>                                                                                                                                                            
                </div>                                                                                                                                      
              </div>
            </div> 
